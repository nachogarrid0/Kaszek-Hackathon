  ...
  return (
    <div className="glass rounded-2xl overflow-hidden border border-white/[0.08]">
      <div className="px-5 py-4 border-b border-white/[0.06] bg-white/[0.02]">
        <h3 className="text-[10px] font-medium text-zinc-500 uppercase tracking-wider">Open Positions</h3>
      </div>
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/[0.06] bg-white/[0.01]">
              <th className="text-left px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">Asset</th>
              <th className="text-right px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">Entry</th>
              <th className="text-right px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">Current</th>
              <th className="text-right px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">PnL $</th>
              <th className="text-right px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">PnL %</th>
              <th className="text-center px-5 py-3 text-[10px] uppercase font-semibold text-zinc-500">Status</th>
            </tr>
          </thead>
          <tbody>
